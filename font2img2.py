...
final_unicode= open('C:/Users/dneir/PycharmProjects/Prography_Font/zi2zi/unicode/unicode200.txt','r')
final_unicode_list=final_unicode.readlines()
final_dir=('C:/Users/dneir/PycharmProjects/Prography_Font/zi2zi/train_font2img')
...
def font2img(src, dst, charset,
    ...
    for c in charset:
        ...
        for i in final_unicode_list:
            if charset == final_unicode_list:

                e.save(os.path.join(final_dir, "%d_%04d.jpg" % (label, count)))
                count += 1
               # if count % 100 == 0:
